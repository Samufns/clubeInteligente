...
.enddata
.head 3 +  Functional Class: cDBVESPECIALIDADE
.head 4 -  Description:
.head 4 +  Derived From
...
'Select ID,  NOME,  AREA,  CODIGO,
IDADE,  TIPO
Into  :nID,  :sNOME,  :sAREA,  :sCODIGO,
:nIDADE,  :sTIPO 
From DBVESPECIALIDADE 
Where ID = :nID_p' )
.head 8 +  If SqlFetchNext( hSqlParam, nFetch )
.head 9 -  Set sNOME = SalStrTrimX( sNOME )
.head 9 -  Set sAREA = SalStrTrimX( sAREA )
.head 9 -  Set sCODIGO = SalStrTrimX( sCODIGO )
.head 9 -  Set sTIPO = SalStrTrimX( sTIPO )
...
.head 7 -  Set sAREA = STRING_Null
.head 7 -  Set sCODIGO = STRING_Null
.head 7 -  Set nIDADE = NUMBER_Null
...
.head 8 -  Class: cDBVESPECIALIDADE
.head 6 -  Static Variables
.head 6 -  Local variables
.head 6 +  Actions
.head 7 -  Set nID = oOrigem_p.nID
.head 7 -  Set sNOME = oOrigem_p.sNOME
.head 7 -  Set sAREA = oOrigem_p.sAREA
.head 7 -  Set sCODIGO = oOrigem_p.sCODIGO
.head 7 -  Set nIDADE = oOrigem_p.nIDADE
...
.head 9 -  Return FALSE
.head 8 -  Call SqlPrepareAndExecute( hSqlParam, 'Insert into DBVESPECIALIDADE 
( ID,  NOME,  AREA,  CODIGO,
IDADE,  TIPO )
 Values 
( :nID,  :sNOME,  :sAREA,  :sCODIGO,
:nIDADE,  :sTIPO ) ' )
.head 8 +  If bUpdate
...
.head 8 -  Call SqlSetIsolationLevel( hSqlParam, 'RL' )
.head 8 -  Call SqlPrepareAndExecute( hSqlParam, 'Delete From DBVESPECIALIDADE
Where ID = :nID' )
...
.head 7 +  If VerificaCampos() And VerificaCamposCustom( )
.head 8 -  Call SqlSetIsolationLevel( hSqlParam, 'RL' )
.head 8 -  Call SqlPrepareAndExecute( hSqlParam, 'Update DBVESPECIALIDADE
Set NOME = :sNOME,
AREA = :sAREA,
CODIGO = :sCODIGO,
IDADE = :nIDADE,
...
.head 7 +  If SalStrLength( sNOME  ) > 200
.head 8 -  Call oErro.AddMessage( ERRO_INTEGRIDADE, 'O tamanho de NOME excede o tamanho permitido.' )
.head 8 -  Return FALSE
.head 7 +  If SalStrLength( sAREA  ) > 10
.head 8 -  Call oErro.AddMessage( ERRO_INTEGRIDADE, 'O tamanho de AREA excede o tamanho permitido.' )
.head 8 -  Return FALSE
.head 7 +  If SalStrLength( sCODIGO  ) > 10
.head 8 -  Call oErro.AddMessage( ERRO_INTEGRIDADE, 'O tamanho de CODIGO excede o tamanho permitido.' )
.head 8 -  Return FALSE
.head 7 +  If SalStrLength( sTIPO  ) > 20
.head 8 -  Call oErro.AddMessage( ERRO_INTEGRIDADE, 'O tamanho de TIPO excede o tamanho permitido.' )
.head 8 -  Return FALSE
.head 7 -  Return TRUE
...
.head 6 -  Local variables
.head 6 +  Actions
.head 7 -  Return 'cDBVESPECIALIDADE'
...
.head 7 -  Call SqlPrepareAndExecute( hSqlParam, 'Insert into SSTLogDetalhe ( SISTEMA, SEQNO, OBJETO, INDICE, VALOR )
 values (:sSistemaGlobal, :nSeqNo, \'AREA\', 2, ' || sAREA || '  )'  )
.head 7 -  Call SqlPrepareAndExecute( hSqlParam, 'Insert into SSTLogDetalhe ( SISTEMA, SEQNO, OBJETO, INDICE, VALOR )
 values (:sSistemaGlobal, :nSeqNo, \'CODIGO\', 3, ' || sCODIGO || '  )'  )
.head 7 -  Call SqlPrepareAndExecute( hSqlParam, 'Insert into SSTLogDetalhe ( SISTEMA, SEQNO, OBJETO, INDICE, VALOR )
 values (:sSistemaGlobal, :nSeqNo, \'IDADE\', 4, ' || SalNumberToStrX( nIDADE, 7 )  || '  )'  )
.head 7 -  Call SqlPrepareAndExecute( hSqlParam, 'Insert into SSTLogDetalhe ( SISTEMA, SEQNO, OBJETO, INDICE, VALOR )
 values (:sSistemaGlobal, :nSeqNo, \'TIPO\', 5, ' || sTIPO || '  )'  )
.head 7 -  Return TRUE
...
.head 6 +  Actions
.head 7 -  Call SqlPrepareAndExecute( hSqlParam, 'Select MAX(ID) Into :nMAXID From DBVESPECIALIDADE' )
...
.head 3 +  Functional Class: cDBVESPECIALIDADE_Vetor
.head 4 -  Description:
.head 4 +  Derived From
...
.head 5 -  FunctionalVar: oDBVESPECIALIDADE[*]
.head 6 -  Class: cDBVESPECIALIDADE
.head 4 +  Functions
.head 5 +  Function: Reset
.head 6 -  Description:
.head 6 -  Returns
...
.head 6 -  Local variables
.head 6 +  Actions
.head 7 -  Call SalArraySetUpperBound( oDBVESPECIALIDADE , 1, -1 )
...
Select ID,  NOME,  AREA,  CODIGO,
IDADE,  TIPO
Into  :oDBVESPECIALIDADE[nInd].nID,  :oDBVESPECIALIDADE[nInd].sNOME,  :oDBVESPECIALIDADE[nInd].sAREA,
:oDBVESPECIALIDADE[nInd].sCODIGO,  :oDBVESPECIALIDADE[nInd].nIDADE,  :oDBVESPECIALIDADE[nInd].sTIPO 
From DBVESPECIALIDADE ' || sWhere || ' 
...
.head 8 -  Set oDBVESPECIALIDADE[nVetorPos].nID = SalStrToNumber( sValor )
.head 7 +  Else If sNomeVar = 'sNOME'
.head 8 -  Set oDBVESPECIALIDADE[nVetorPos].sNOME = sValor
.head 7 +  Else If sNomeVar = 'sAREA'
.head 8 -  Set oDBVESPECIALIDADE[nVetorPos].sAREA = sValor
.head 7 +  Else If sNomeVar = 'sCODIGO'
.head 8 -  Set oDBVESPECIALIDADE[nVetorPos].sCODIGO = sValor
.head 7 +  Else If sNomeVar = 'nIDADE'
.head 8 -  Set oDBVESPECIALIDADE[nVetorPos].nIDADE = SalStrToNumber( sValor )
.head 7 +  Else If sNomeVar = 'sTIPO'
.head 8 -  Set oDBVESPECIALIDADE[nVetorPos].sTIPO = sValor
.head 7 -  Return TRUE
...
.head 6 +  Actions
.head 7 +  If sNomeVar = 'nID'
.head 8 -  Call vParamExport.SetNumber( oDBVESPECIALIDADE[nVetorPos].nID , VT_R8 )
.head 7 +  Else If sNomeVar = 'sNOME'
.head 8 -  Call vParamExport.SetString( oDBVESPECIALIDADE[nVetorPos].sNOME)
.head 7 +  Else If sNomeVar = 'sAREA'
.head 8 -  Call vParamExport.SetString( oDBVESPECIALIDADE[nVetorPos].sAREA)
.head 7 +  Else If sNomeVar = 'sCODIGO'
.head 8 -  Call vParamExport.SetString( oDBVESPECIALIDADE[nVetorPos].sCODIGO)
.head 7 +  Else If sNomeVar = 'nIDADE'
.head 8 -  Call vParamExport.SetNumber( oDBVESPECIALIDADE[nVetorPos].nIDADE , VT_R8 )
.head 7 +  Else If sNomeVar = 'sTIPO'
.head 8 -  Call vParamExport.SetString( oDBVESPECIALIDADE[nVetorPos].sTIPO)
...
.head 7 +  If nIndice >= 0
.head 8 -  Set sCondicao = VisStrSubstitute( sConditionsLog[nIndice], '%COLUNA', 'oDBVESPECIALIDADE[ nVetorPos ].' || sColuna )
...
.head 8 -  Return oDBVESPECIALIDADE[nLinha].Insert( hSqlParam )
.head 7 +  Else If sOperacao = '22'
.head 8 -  Return oDBVESPECIALIDADE[nLinha].Delete( hSqlParam )
.head 7 +  Else If sOperacao = '33'
.head 8 -  Return oDBVESPECIALIDADE[nLinha].Update( hSqlParam )
