...
.enddata
.head 3 +  Functional Class: cDBVPESSOA
.head 4 -  Description:
.head 4 +  Derived From
...
.head 5 -  Number: nID
.head 5 -  String: sCPFCGC
.head 5 -  String: sNOME
.head 5 -  String: sAPELIDO
.head 5 -  String: sGENERO
.head 5 -  Date/Time: dtNASCIMENTO
.head 5 -  Date/Time: dtCADASTRO
.head 5 -  String: sEMAIL
.head 5 -  String: sTELEFONE
.head 5 -  String: sFOTO
.head 5 -  String: sTIPOPESSOA
...
'Select ID,  CPFCGC,  NOME,  APELIDO,
GENERO,  NASCIMENTO,  CADASTRO,  EMAIL,
TELEFONE,  FOTO,  TIPOPESSOA,  STATUS
Into  :nID,  :sCPFCGC,  :sNOME,  :sAPELIDO,
:sGENERO,  :dtNASCIMENTO,  :dtCADASTRO,  :sEMAIL,
:sTELEFONE,  :sFOTO,  :sTIPOPESSOA,  :sSTATUS 
From DBVPESSOA 
Where ID = :nID_p' )
.head 8 +  If SqlFetchNext( hSqlParam, nFetch )
.head 9 -  Set sCPFCGC = SalStrTrimX( sCPFCGC )
.head 9 -  Set sNOME = SalStrTrimX( sNOME )
.head 9 -  Set sAPELIDO = SalStrTrimX( sAPELIDO )
.head 9 -  Set sGENERO = SalStrTrimX( sGENERO )
.head 9 -  Set sEMAIL = SalStrTrimX( sEMAIL )
.head 9 -  Set sTELEFONE = SalStrTrimX( sTELEFONE )
.head 9 -  Set sFOTO = SalStrTrimX( sFOTO )
.head 9 -  Set sTIPOPESSOA = SalStrTrimX( sTIPOPESSOA )
.head 9 -  Set sSTATUS = SalStrTrimX( sSTATUS )
...
.head 7 -  Set sCPFCGC = STRING_Null
.head 7 -  Set sNOME = STRING_Null
.head 7 -  Set sAPELIDO = STRING_Null
.head 7 -  Set sGENERO = STRING_Null
.head 7 -  Set dtNASCIMENTO = DATETIME_Null
.head 7 -  Set dtCADASTRO = DATETIME_Null
.head 7 -  Set sEMAIL = STRING_Null
.head 7 -  Set sTELEFONE = STRING_Null
.head 7 -  Set sFOTO = STRING_Null
.head 7 -  Set sTIPOPESSOA = STRING_Null
.head 7 -  Set sSTATUS = STRING_Null
...
.head 8 -  Class: cDBVPESSOA
.head 6 -  Static Variables
.head 6 -  Local variables
.head 6 +  Actions
.head 7 -  Set nID = oOrigem_p.nID
.head 7 -  Set sCPFCGC = oOrigem_p.sCPFCGC
.head 7 -  Set sNOME = oOrigem_p.sNOME
.head 7 -  Set sAPELIDO = oOrigem_p.sAPELIDO
.head 7 -  Set sGENERO = oOrigem_p.sGENERO
.head 7 -  Set dtNASCIMENTO = oOrigem_p.dtNASCIMENTO
.head 7 -  Set dtCADASTRO = oOrigem_p.dtCADASTRO
.head 7 -  Set sEMAIL = oOrigem_p.sEMAIL
.head 7 -  Set sTELEFONE = oOrigem_p.sTELEFONE
.head 7 -  Set sFOTO = oOrigem_p.sFOTO
.head 7 -  Set sTIPOPESSOA = oOrigem_p.sTIPOPESSOA
.head 7 -  Set sSTATUS = oOrigem_p.sSTATUS
.head 7 -  Set bInitialized = FALSE
...
.head 9 -  Return FALSE
.head 8 -  Call SqlPrepareAndExecute( hSqlParam, 'Insert into DBVPESSOA 
( ID,  CPFCGC,  NOME,  APELIDO,
GENERO,  NASCIMENTO,  CADASTRO,  EMAIL,
TELEFONE,  FOTO,  TIPOPESSOA,  STATUS )
 Values 
( :nID,  :sCPFCGC,  :sNOME,  :sAPELIDO,
:sGENERO,  :dtNASCIMENTO,  :dtCADASTRO,  :sEMAIL,
:sTELEFONE,  :sFOTO,  :sTIPOPESSOA,  :sSTATUS ) ' )
.head 8 +  If bUpdate
...
.head 8 -  Call SqlSetIsolationLevel( hSqlParam, 'RL' )
.head 8 -  Call SqlPrepareAndExecute( hSqlParam, 'Delete From DBVPESSOA
Where ID = :nID' )
...
.head 7 +  If VerificaCampos() And VerificaCamposCustom( )
.head 8 -  Call SqlSetIsolationLevel( hSqlParam, 'RL' )
.head 8 -  Call SqlPrepareAndExecute( hSqlParam, 'Update DBVPESSOA
Set CPFCGC = :sCPFCGC,
NOME = :sNOME,
APELIDO = :sAPELIDO,
GENERO = :sGENERO,
...
.head 7 +  If SalStrLength( sCPFCGC  ) > 20
.head 8 -  Call oErro.AddMessage( ERRO_INTEGRIDADE, 'O tamanho de CPFCGC excede o tamanho permitido.' )
.head 8 -  Return FALSE
...
.head 8 -  Return FALSE
.head 7 +  If SalStrLength( sAPELIDO  ) > 20
.head 8 -  Call oErro.AddMessage( ERRO_INTEGRIDADE, 'O tamanho de APELIDO excede o tamanho permitido.' )
.head 8 -  Return FALSE
.head 7 +  If SalStrLength( sGENERO  ) > 1
.head 8 -  Call oErro.AddMessage( ERRO_INTEGRIDADE, 'O tamanho de GENERO excede o tamanho permitido.' )
.head 8 -  Return FALSE
.head 7 +  If SalStrLength( sEMAIL  ) > 100
.head 8 -  Call oErro.AddMessage( ERRO_INTEGRIDADE, 'O tamanho de EMAIL excede o tamanho permitido.' )
.head 8 -  Return FALSE
.head 7 +  If SalStrLength( sTELEFONE  ) > 30
.head 8 -  Call oErro.AddMessage( ERRO_INTEGRIDADE, 'O tamanho de TELEFONE excede o tamanho permitido.' )
.head 8 -  Return FALSE
.head 7 +  If SalStrLength( sFOTO  ) > 100
.head 8 -  Call oErro.AddMessage( ERRO_INTEGRIDADE, 'O tamanho de FOTO excede o tamanho permitido.' )
.head 8 -  Return FALSE
.head 7 +  If SalStrLength( sTIPOPESSOA  ) > 1
.head 8 -  Call oErro.AddMessage( ERRO_INTEGRIDADE, 'O tamanho de TIPOPESSOA excede o tamanho permitido.' )
.head 8 -  Return FALSE
.head 7 +  If SalStrLength( sSTATUS  ) > 1
.head 8 -  Call oErro.AddMessage( ERRO_INTEGRIDADE, 'O tamanho de STATUS excede o tamanho permitido.' )
.head 8 -  Return FALSE
.head 7 -  Return TRUE
...
.head 7 -  Call SqlPrepareAndExecute( hSqlParam, 'Insert into SSTLogDetalhe ( SISTEMA, SEQNO, OBJETO, INDICE, VALOR )
 values (:sSistemaGlobal, :nSeqNo, \'CPFCGC\', 1, ' || sCPFCGC || '  )'  )
.head 7 -  Call SqlPrepareAndExecute( hSqlParam, 'Insert into SSTLogDetalhe ( SISTEMA, SEQNO, OBJETO, INDICE, VALOR )
 values (:sSistemaGlobal, :nSeqNo, \'NOME\', 2, ' || sNOME || '  )'  )
.head 7 -  Call SqlPrepareAndExecute( hSqlParam, 'Insert into SSTLogDetalhe ( SISTEMA, SEQNO, OBJETO, INDICE, VALOR )
 values (:sSistemaGlobal, :nSeqNo, \'APELIDO\', 3, ' || sAPELIDO || '  )'  )
.head 7 -  Call SqlPrepareAndExecute( hSqlParam, 'Insert into SSTLogDetalhe ( SISTEMA, SEQNO, OBJETO, INDICE, VALOR )
 values (:sSistemaGlobal, :nSeqNo, \'GENERO\', 4, ' || sGENERO || '  )'  )
.head 7 -  Call SqlPrepareAndExecute( hSqlParam, 'Insert into SSTLogDetalhe ( SISTEMA, SEQNO, OBJETO, INDICE, VALOR )
 values (:sSistemaGlobal, :nSeqNo, \'NASCIMENTO\', 5, ' || SalFmtFormatDateTime( dtNASCIMENTO, 'yyyyMMddhhhhmmss' )  || '  )'  )
.head 7 -  Call SqlPrepareAndExecute( hSqlParam, 'Insert into SSTLogDetalhe ( SISTEMA, SEQNO, OBJETO, INDICE, VALOR )
 values (:sSistemaGlobal, :nSeqNo, \'CADASTRO\', 6, ' || SalFmtFormatDateTime( dtCADASTRO, 'yyyyMMddhhhhmmss' )  || '  )'  )
.head 7 -  Call SqlPrepareAndExecute( hSqlParam, 'Insert into SSTLogDetalhe ( SISTEMA, SEQNO, OBJETO, INDICE, VALOR )
 values (:sSistemaGlobal, :nSeqNo, \'EMAIL\', 7, ' || sEMAIL || '  )'  )
.head 7 -  Call SqlPrepareAndExecute( hSqlParam, 'Insert into SSTLogDetalhe ( SISTEMA, SEQNO, OBJETO, INDICE, VALOR )
 values (:sSistemaGlobal, :nSeqNo, \'TELEFONE\', 8, ' || sTELEFONE || '  )'  )
.head 7 -  Call SqlPrepareAndExecute( hSqlParam, 'Insert into SSTLogDetalhe ( SISTEMA, SEQNO, OBJETO, INDICE, VALOR )
 values (:sSistemaGlobal, :nSeqNo, \'FOTO\', 9, ' || sFOTO || '  )'  )
.head 7 -  Call SqlPrepareAndExecute( hSqlParam, 'Insert into SSTLogDetalhe ( SISTEMA, SEQNO, OBJETO, INDICE, VALOR )
 values (:sSistemaGlobal, :nSeqNo, \'TIPOPESSOA\', 10, ' || sTIPOPESSOA || '  )'  )
.head 7 -  Call SqlPrepareAndExecute( hSqlParam, 'Insert into SSTLogDetalhe ( SISTEMA, SEQNO, OBJETO, INDICE, VALOR )
 values (:sSistemaGlobal, :nSeqNo, \'STATUS\', 11, ' || sSTATUS || '  )'  )
.head 7 -  Return TRUE
...
.head 6 +  Actions
.head 7 -  Call SqlPrepareAndExecute( hSqlParam, 'Select MAX(ID) Into :nMAXID From DBVPESSOA' )
...
.head 3 +  Functional Class: cDBVPESSOA_Vetor
.head 4 -  Description:
.head 4 +  Derived From
...
.head 5 -  FunctionalVar: oDBVPESSOA[*]
.head 6 -  Class: cDBVPESSOA
.head 4 +  Functions
.head 5 +  Function: Reset
.head 6 -  Description:
.head 6 -  Returns
...
.head 6 -  Local variables
.head 6 +  Actions
.head 7 -  Call SalArraySetUpperBound( oDBVPESSOA , 1, -1 )
...
GENERO,  NASCIMENTO,  CADASTRO,  EMAIL,
TELEFONE,  FOTO,  TIPOPESSOA,  STATUS
Into  :oDBVPESSOA[nInd].nID,  :oDBVPESSOA[nInd].sCPFCGC,  :oDBVPESSOA[nInd].sNOME,
:oDBVPESSOA[nInd].sAPELIDO,  :oDBVPESSOA[nInd].sGENERO,  :oDBVPESSOA[nInd].dtNASCIMENTO,
:oDBVPESSOA[nInd].dtCADASTRO,  :oDBVPESSOA[nInd].sEMAIL,  :oDBVPESSOA[nInd].sTELEFONE,
:oDBVPESSOA[nInd].sFOTO,  :oDBVPESSOA[nInd].sTIPOPESSOA,  :oDBVPESSOA[nInd].sSTATUS 
From DBVPESSOA ' || sWhere || ' 
...
.head 8 -  Set oDBVPESSOA[nVetorPos].nID = SalStrToNumber( sValor )
.head 7 +  Else If sNomeVar = 'sCPFCGC'
.head 8 -  Set oDBVPESSOA[nVetorPos].sCPFCGC = sValor
.head 7 +  Else If sNomeVar = 'sNOME'
.head 8 -  Set oDBVPESSOA[nVetorPos].sNOME = sValor
.head 7 +  Else If sNomeVar = 'sAPELIDO'
.head 8 -  Set oDBVPESSOA[nVetorPos].sAPELIDO = sValor
.head 7 +  Else If sNomeVar = 'sGENERO'
.head 8 -  Set oDBVPESSOA[nVetorPos].sGENERO = sValor
.head 7 +  Else If sNomeVar = 'dtNASCIMENTO'
.head 8 -  Set oDBVPESSOA[nVetorPos].dtNASCIMENTO = FormataDataLida( sValor) 
.head 7 +  Else If sNomeVar = 'dtCADASTRO'
.head 8 -  Set oDBVPESSOA[nVetorPos].dtCADASTRO = FormataDataLida( sValor) 
.head 7 +  Else If sNomeVar = 'sEMAIL'
.head 8 -  Set oDBVPESSOA[nVetorPos].sEMAIL = sValor
.head 7 +  Else If sNomeVar = 'sTELEFONE'
.head 8 -  Set oDBVPESSOA[nVetorPos].sTELEFONE = sValor
.head 7 +  Else If sNomeVar = 'sFOTO'
.head 8 -  Set oDBVPESSOA[nVetorPos].sFOTO = sValor
.head 7 +  Else If sNomeVar = 'sTIPOPESSOA'
.head 8 -  Set oDBVPESSOA[nVetorPos].sTIPOPESSOA = sValor
.head 7 +  Else If sNomeVar = 'sSTATUS'
.head 8 -  Set oDBVPESSOA[nVetorPos].sSTATUS = sValor
.head 7 -  Return TRUE
...
.head 6 +  Actions
.head 7 +  If sNomeVar = 'nID'
.head 8 -  Call vParamExport.SetNumber( oDBVPESSOA[nVetorPos].nID , VT_R8 )
.head 7 +  Else If sNomeVar = 'sCPFCGC'
.head 8 -  Call vParamExport.SetString( oDBVPESSOA[nVetorPos].sCPFCGC)
.head 7 +  Else If sNomeVar = 'sNOME'
.head 8 -  Call vParamExport.SetString( oDBVPESSOA[nVetorPos].sNOME)
.head 7 +  Else If sNomeVar = 'sAPELIDO'
.head 8 -  Call vParamExport.SetString( oDBVPESSOA[nVetorPos].sAPELIDO)
.head 7 +  Else If sNomeVar = 'sGENERO'
.head 8 -  Call vParamExport.SetString( oDBVPESSOA[nVetorPos].sGENERO)
.head 7 +  Else If sNomeVar = 'dtNASCIMENTO'
.head 8 -  Call vParamExport.SetDate( oDBVPESSOA[nVetorPos].dtNASCIMENTO)
.head 7 +  Else If sNomeVar = 'dtCADASTRO'
.head 8 -  Call vParamExport.SetDate( oDBVPESSOA[nVetorPos].dtCADASTRO)
.head 7 +  Else If sNomeVar = 'sEMAIL'
.head 8 -  Call vParamExport.SetString( oDBVPESSOA[nVetorPos].sEMAIL)
.head 7 +  Else If sNomeVar = 'sTELEFONE'
.head 8 -  Call vParamExport.SetString( oDBVPESSOA[nVetorPos].sTELEFONE)
.head 7 +  Else If sNomeVar = 'sFOTO'
.head 8 -  Call vParamExport.SetString( oDBVPESSOA[nVetorPos].sFOTO)
.head 7 +  Else If sNomeVar = 'sTIPOPESSOA'
.head 8 -  Call vParamExport.SetString( oDBVPESSOA[nVetorPos].sTIPOPESSOA)
.head 7 +  Else If sNomeVar = 'sSTATUS'
.head 8 -  Call vParamExport.SetString( oDBVPESSOA[nVetorPos].sSTATUS)
...
.head 7 +  If nIndice >= 0
.head 8 -  Set sCondicao = VisStrSubstitute( sConditionsLog[nIndice], '%COLUNA', 'oDBVPESSOA[ nVetorPos ].' || sColuna )
...
.head 8 -  Return oDBVPESSOA[nLinha].Insert( hSqlParam )
.head 7 +  Else If sOperacao = '22'
.head 8 -  Return oDBVPESSOA[nLinha].Delete( hSqlParam )
.head 7 +  Else If sOperacao = '33'
.head 8 -  Return oDBVPESSOA[nLinha].Update( hSqlParam )
